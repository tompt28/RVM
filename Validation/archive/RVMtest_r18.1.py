...
# r17 - DB Tidy up. fully working Scenario tests added.
# r18 - additional check added on cycle test. when SOV turns off    
...
try:
    ...
    fileName = "/home/pi/RVM/Validation/Database/%s.sqlite" % Serial
    ...
    if __name__ == '__main__':
        database = "/home/pi/RVM/Validation/Database/%s.sqlite" % Serial
