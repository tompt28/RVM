...
try:
    ...
    Email = str("0")
    while Email[0] != "Y" or Email[0] != "N":
        Email = input("would you like email notification on major failures (unexpected output loss) Please enter Y/N:").upper()
        if Email =="Y":
            reciver_email = str(input("what is your email address?:"))
            break
        elif Email == "N": 
            reciver_email = "tompneumatrol@gmail.com"
            break
        else:
