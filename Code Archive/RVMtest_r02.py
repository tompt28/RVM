...
#RVM pressure hold and cycle test CLI_r01
## runs test
#RVMtest_r01 = crates a db
#RVMtest_r02= write to db
...
try:
	...
	if __name__ == '__main__':
		...
		sql_create_testData_table = """CREATE TABLE testData(
		...
		if conn is not None:
			...
			try:
				c = conn.cursor()
				c.execute(sql_create_testData_table)
			except Error as e:	
				print(e)
