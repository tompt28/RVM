...
try:
    ...
    if Email == "Y":
        ...
        print("hi {},\nYou have selected not to have email reporting. Please check on the test periodically.\n "
...
# cleanup
    ...
    database = ""
    while database == "" or database[0] != "N" or database[0] != "y":
        database = input("would you like to open the test database? please enter Y/N").upper()
        if database == "Y":
