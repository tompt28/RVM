#!/usr/bin/env python
# coding: utf-8
# r01 - New Script for assembly use
# r02 - update to allow multipul testing of the same part. ( prev version overwrote DBtables)+ additional check added on cycle test. when SOV turns off   
...
try:
    ...
    fileName = "/home/pi/RVM/Assembly/TestDB/%s-%s-%s.sqlite" % (Sales_Order, Part_code, Serial)
    ...
    if __name__ == '__main__':
        database = "/home/pi/RVM/Assembly/TestDB/%s-%s-%s.sqlite" % (Sales_Order, Part_code, Serial)
